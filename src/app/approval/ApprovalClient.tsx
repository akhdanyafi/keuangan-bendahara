              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-slate-100 bg-slate-50">
                    ...
                    <th className="px-3 sm:px-5 py-3 text-left text-xs font-semibold text-slate-500 hidden sm:table-cell">Pengaju</th>
                    ...
                    <th className="px-3 sm:px-5 py-3 text-left text-xs font-semibold text-slate-500 hidden md:table-cell">Tanggal</th>
                ...
                <tbody className="divide-y divide-slate-50">
                  {data.map((p) => (
                    <tr key={p.id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      <td className="px-3 sm:px-5 py-3.5 text-sm text-slate-500 hidden sm:table-cell">{p.pengaju_nama}</td>
                      ...
                      <td className="px-3 sm:px-5 py-3.5 text-sm text-slate-400 hidden md:table-cell">
